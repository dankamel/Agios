//
//  StoriesWithoutIconsView.swift
//  Agios
//
//  Created by Victor on 11/3/24.
//
...
//                    .background(.white)
        ...
        .heroLayer(id: "\(stories.id ?? "")", animate: $showView, sourceCornerRadius: 16, destinationCornerRadius: 24) {
            Rectangle()
                .fill(.clear)
                .background(
                    ZStack {
        ...
        ZStack {
            if showImageViewer {
                ...
                .background(
                    Image("placeholder")
                        .resizable()
                        .matchedGeometryEffect(id: "\(stories.id ?? "")", in: namespace)
                        .scaledToFit()
                ...
                .mask({
                    RoundedRectangle(cornerRadius: 0)
                        .matchedGeometryEffect(id: "\(stories.saint ?? "")", in: namespace)
                })
